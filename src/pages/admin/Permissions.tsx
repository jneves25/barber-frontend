...
import { User, Shield, Edit, Trash2, Plus, Save, X, AlertCircle, UserPlus } from 'lucide-react';
...
import UserService, { RoleEnum, User as UserType } from '@/services/api/UserService';
					...
					<Dialog open={!!selectedUser} onOpenChange={(open) => !open && setSelectedUser(null)}>
						<DialogContent className="max-w-3xl max-h-[80vh] overflow-y-auto">
							...
							<div className="py-4">
								<div className="mb-4">
									...
									<Select
										...
										onValueChange={(value: RoleEnum) => setSelectedUser({ ...selectedUser, role: value })}
									>
							...
							<DialogFooter>
								...
								<Button onClick={() => handleEditUser(selectedUser)}>Salvar Alterações</Button>
							</DialogFooter>
						</DialogContent>
					</Dialog>
				)}
